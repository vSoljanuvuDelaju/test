...
class MountainTest {
    ...
    fun mountainTestMethod() {

        val appContext: Context = InstrumentationRegistry.getInstrumentation().context

        val bitmap = ImageHelper.resizeBitmap(MediaStore.Images.Media.getBitmap(appContext.contentResolver, "com/travels/searchtravels/screenshots/mountainPhoto.jpg".toUri()))
        ...
        Assert.assertEquals("mountain", response)
    }
}