...
class SeaTest {
    ...
    fun seaTestMethod() {
        ...
        val bitmap = ImageHelper.resizeBitmap(MediaStore.Images.Media.getBitmap(applicationContext.contentResolver, "com/travels/searchtravels/screenshots/seaPhoto.jpg".toUri()))
        ...
        Assert.assertEquals("sea", response)
    }
