...
class BeachTest {
    ...
    fun beachTestMethod() {
        ...
        val bitmap = ImageHelper.resizeBitmap(MediaStore.Images.Media.getBitmap(appContext.contentResolver, "com/travels/searchtravels/screenshots/beachPhoto.jpg".toUri()))
        ...
        Assert.assertEquals("beach", response)
    }
