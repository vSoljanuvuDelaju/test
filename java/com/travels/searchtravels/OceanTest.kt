...
class OceanTest {
    ...
    fun oceanTestMethod() {
        ...
        val bitmap = ImageHelper.resizeBitmap(MediaStore.Images.Media.getBitmap(appContext.contentResolver, "com/travels/searchtravels/screenshots/oceanPhoto.jpg".toUri()))
        ...
        Assert.assertEquals("ocean", response)
    }
}